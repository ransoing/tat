...
function importHardwareBackButton(win) {
    if (Object(_chunk_e7816c0b_js__WEBPACK_IMPORTED_MODULE_2__["m"])(win, 'hybrid')) {
        __webpack_require__.e(/*! import() */ 158).then(__webpack_require__.bind(null, /*! ./hardware-back-button.js */ "./node_modules/@ionic/core/dist/esm/es5/build/hardware-back-button.js")).then(function (module) { return module.startHardwareBackButton(win); });
    }
}
function importStatusTap(win, queue) {
    if (Object(_chunk_e7816c0b_js__WEBPACK_IMPORTED_MODULE_2__["m"])(win, 'hybrid')) {
        __webpack_require__.e(/*! import() */ 159).then(__webpack_require__.bind(null, /*! ./status-tap.js */ "./node_modules/@ionic/core/dist/esm/es5/build/status-tap.js")).then(function (module) { return module.startStatusTap(win, queue); });
    }
}
function importTapClick(win) {
    __webpack_require__.e(/*! import() */ 160).then(__webpack_require__.bind(null, /*! ./tap-click.js */ "./node_modules/@ionic/core/dist/esm/es5/build/tap-click.js")).then(function (module) { return module.startTapClick(win.document); });
}
function importInputShims(win, config) {
    var inputShims = config.getBoolean('inputShims', needInputShims(win));
    if (inputShims) {
        __webpack_require__.e(/*! import() */ 161).then(__webpack_require__.bind(null, /*! ./input-shims.js */ "./node_modules/@ionic/core/dist/esm/es5/build/input-shims.js")).then(function (module) { return module.startInputShims(win.document, config); });
    }
}
